...
if ($autor == 1){
					$checked_autor="selected=\"selected\"";
				} else {
					$checked_autor = ""; 
}
if ($responsavel == 1){
					$checked_responsavel="selected=\"selected\"";
				} else {
					$checked_responsavel = ""; 
}
if ($coresponsavel == 1){
					$checked_coresponsavel="selected=\"selected\"";
				} else {
					$checked_coresponsavel = ""; 
}
if ($requerente == 1){
					$checked_requerente="selected=\"selected\"";
				} else {
					$checked_requerente = ""; 
}
if ($utiliza_sistema == 1){
					$checked_utiliza_sistema="selected=\"selected\"";
				} else {
...
<script type="text/javascript" src="http://www.nasajonsistemas.com.br/extranet/tarifacao/js/jquery.js"></script>

<script type="text/javascript" src="http://www.nasajonsistemas.com.br/extranet/tarifacao/js/bootstrap.min.js"></script>
<script type="text/javascript" src="http://www.nasajonsistemas.com.br/extranet/tarifacao/js/bootstrap-multiselect.js"></script>

<script type="text/javascript" src="http://www.nasajonsistemas.com.br/extranet/js/jquery.click-calendario-1.0-min.js"></script>
<link href="http://www.nasajonsistemas.com.br/extranet/tarifacao/css/bootstrap.css" rel="stylesheet" type="text/css"/>
<link href="http://www.nasajonsistemas.com.br/extranet/agenda/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css"/>
...
return true;
 ...
 $(document).ready(function() {
                $('#tipoResponsabilidade').multiselect();
...
<script type="text/javascript"  src="http://www.nasajonsistemas.com.br/extranet/agenda/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="http://www.nasajonsistemas.com.br/extranet/agenda/js/bootstrap-datetimepicker.pt-BR.js"></script>
<script type="text/javascript">	
 ...
 $(document).click(function() {
	var valor = $("#tipoResponsabilidade").val();
	if(valor.indexOf("autor") >= 0){
		$("#autor").val("1");
	}else{
		$("#autor").val("0");
	}
	if(valor.indexOf("responsavel") >= 0){
		$("#responsavel").val("1");
	}else{
	$("#responsavel").val("0");
	}
	if(valor.indexOf("coresponsavel") >= 0){
		$("#coresponsavel").val("1");
	}else{
	$("#coresponsavel").val("0");
	}
	if(valor.indexOf("requerente") >= 0){
		$("#requerente").val("1");
	}else{
	$("#requerente").val("0");
	}
...
<p>
  ...
  <select id="tipoResponsabilidade" name="tipoResponsabilidade" multiple="multiple" onchange="ver()" >
	<option value="autor" <?php print $checked_autor;  ?>>Autor</option>
	<option value="responsavel" <?php print $checked_responsavel;  ?>>Responsável</option>
	<option value="coresponsavel" <?php print $checked_coresponsavel;  ?>>Co-Responsável</option>
	<option value="requerente" <?php print $checked_requerente;  ?>>Requerente</option>
  </select>
  <input type="hidden" name="autor" id="autor">
  <input type="hidden" name="responsavel" id="responsavel">
  <input type="hidden" name="coresponsavel" id="coresponsavel">
  <input type="hidden" name="requerente" id="requerente">
...
<p>
  ...
  <div id="datetimepicker1" class="input-append date" style="float: left">                                
                    <input data-format="dd/MM/yyyy hh:mm:ss" name="data_cadastro" id="dataAgenda" type="text" style="width: auto">
                       <span class="add-on">
