...
function valida_form() {
	if (document.form_login.codigo.value == "")
...
<p><label>Login:</label><input name="codigo" type="text" class="caixa_texto" size="30" maxlength="30" /></p>
<p><label>Senha:</label><input name="senha" type="password" class="caixa_texto" size="30" maxlength="30" /></p>
<p>&nbsp;</p>
