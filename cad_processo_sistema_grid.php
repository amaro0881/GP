...
$sql = $sql . " ORDER BY id_processo_sistema ";
...
<div id="topo">
  ...
  <p align="center">Listagem dos Sistemas dos Processos</p>
</div>
...
<tr>
<td width="80%"><h1 class="c_cinza">Manutenção Cadastral <img src="./imagens/marcador_setaDir.gif" align="absmiddle" /> <span class="c_preto">Sistema(s)</span></h1></td>
...
<tr id="titulo_tabela">
<td width="26%" class="tabela_titulo">Sistema</td>
<td width="52%" align="right" class="tabela_titulo"><div align="left">Observacao</div></td>
...
<td class="<?PHP print $fundo; ?>"><?PHP print $id_sistema; ?></td>
<td class="<?PHP print $fundo; ?>"><?PHP print $observacao; ?></td>

<!-- Excluir registros -->
<!-- Executa o cadastro de Contato da Entidade com ação de exclusão (exc) -->
<td width="8%" class="<?PHP print $fundo; ?>"><a href="cad_processo_sistema.php?acao=exc&id_processo_sistema=<?PHP print $id_processo_sistema; ?>&titulo=Exclusão de registro"><img src="./imagens/btn_cancelar_reg.gif" alt="Cancelar esse registro" border="0" /></a></td>	

<!-- Alterar registros -->
<!-- Executa o cadastro de Contato da Entidade com ação de alteração (alt) -->
<td width="7%" class="<?PHP print $fundo; ?>"><a href="cad_processo_sistema.php?acao=alt&id_processo_sistema=<?PHP print $id_processo_sistema; ?>&titulo=Alteração de registro"><img src="./imagens/btn_alterar_reg.gif" alt="Alterar esse registro" border="0" /></a></td>	

<!-- Visualizar registros -->
<!-- Executa o cadastro de Contato da Entidade com ação de visualização (ver) -->
<td width="7%" class="<?PHP print $fundo; ?>"><a href="cad_processo_sistema.php?acao=ver&id_processo_sistema=<?PHP print $id_processo_sistema; ?>&titulo=Detalhes do registro"><img src="./imagens/btn_ver_detalhes.gif" alt="Ver detalhes desse registro" border="0" /></a></td>			
</tr>
<?PHP } ?>
</table>
</div>
