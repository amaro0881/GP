...
$sqlCoResponsavel = "SELECT * FROM processo where coresponsavel = '6' ";
...
$sqlRequerente = "SELECT * FROM  processo INNER JOIN processo_requerente ON (processo.id_processo = processo_requerente.id_processo) where processo_requerente.id_requerente = '6' ";
