...
<!-- Incluir registroas -->
<!-- Executa o cadastro dos Sistemas com ação de inserção (ins) -->
<td width="20%"><h1 align="right"><a href="cad_sistema.php?acao=ins&amp;titulo=Inclusão de registro"><img src="./imagens/btn_inserir.gif" alt="Inserir novo registro" border="0" /></a></h1></td>
</tr>
</table>
...
<!-- Excluir registros -->
<!-- Executa o cadastro dos Sistemas com ação de exclusão (exc) -->
<td width="5%" class="<?PHP print $fundo; ?>"><a href="cad_sistema.php?acao=exc&id_sistema=<?PHP print $id_sistema; ?>&titulo=Exclusão de registro"><img src="./imagens/btn_cancelar_reg.gif" alt="Cancelar esse registro" border="0" /></a></td>	

<!-- Alterar registros -->
<!-- Executa o cadastro dos Sistemas com ação de alteração (alt) -->
<td width="5%" class="<?PHP print $fundo; ?>"><a href="cad_sistema.php?acao=alt&id_sistema=<?PHP print $id_sistema; ?>&titulo=Alteração de registro"><img src="./imagens/btn_alterar_reg.gif" alt="Alterar esse registro" border="0" /></a></td>	

<!-- Visualizar registros -->
<!-- Executa o cadastro dos Sistemas com ação de visualização (ver) -->
